...
import { useLocalStorage } from "./components/hooks/useLocalStorageState";
    ...
    function () {
      async function getMovieDetails() {
        try {
          ...
          setMovie(data);
          setIsLoading(false);
          // set a new title for document when we click the movie ==> we can use another effect
      ...
      getMovieDetails();
      // reset the title name to original name
      return function () {
            ...
            <div className="rating">
              {!isWatched ? (
                ...
                <p>
                  ...
                  You Rated this movie <span>🌟</span> {watchUserRating}
                </p>
              )}
            </div>
            <p>
